# python tools/preprocess_droid.py --folder /home/r2d2/R2D2/data/success/icrl_prompt_aug4_sponge/
"""
...
def convert_dataset(path, args):
    ...
    output_path = os.path.join(os.path.dirname(path), "trajectory_im{}_{}.h5".format(args.imsizew, args.imsizeh))
